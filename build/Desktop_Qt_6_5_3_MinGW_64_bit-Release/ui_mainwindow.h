...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        SearchBtn->setMinimumSize(QSize(45, 0));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icon/icon/searchW.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        sizePolicy3.setHeightForWidth(QssBtn->sizePolicy().hasHeightForWidth());
        QssBtn->setSizePolicy(sizePolicy3);
        QssBtn->setMinimumSize(QSize(40, 0));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icon/icon/penW.png"), QSize(), QIcon::Normal, QIcon::Off);
        QssBtn->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icon/icon/minW.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icon/icon/maxW.png"), QSize(), QIcon::Normal, QIcon::Off);
        MaxBtn->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icon/icon/close.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        sizePolicy4.setHeightForWidth(networkBtn->sizePolicy().hasHeightForWidth());
        networkBtn->setSizePolicy(sizePolicy4);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icon/icon/network.png"), QSize(), QIcon::Normal, QIcon::Off);
        networkBtn->setIcon(icon6);
        ...
        sizePolicy4.setHeightForWidth(plotBtn->sizePolicy().hasHeightForWidth());
        plotBtn->setSizePolicy(sizePolicy4);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icon/icon/Curves.png"), QSize(), QIcon::Normal, QIcon::Off);
        plotBtn->setIcon(icon7);
        ...
        sizePolicy4.setHeightForWidth(startBtn->sizePolicy().hasHeightForWidth());
        startBtn->setSizePolicy(sizePolicy4);
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icon/icon/Hi.png"), QSize(), QIcon::Normal, QIcon::Off);
        startBtn->setIcon(icon8);
        ...
        sizePolicy4.setHeightForWidth(modbusBtn->sizePolicy().hasHeightForWidth());
        modbusBtn->setSizePolicy(sizePolicy4);
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icon/icon/com.png"), QSize(), QIcon::Normal, QIcon::Off);
        modbusBtn->setIcon(icon9);
        ...
        sizePolicy4.setHeightForWidth(toolBtn->sizePolicy().hasHeightForWidth());
        toolBtn->setSizePolicy(sizePolicy4);
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icon/icon/tool.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolBtn->setIcon(icon10);
        ...
        sizePolicy4.setHeightForWidth(idBtn->sizePolicy().hasHeightForWidth());
        idBtn->setSizePolicy(sizePolicy4);
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icon/icon/ID.png"), QSize(), QIcon::Normal, QIcon::Off);
        idBtn->setIcon(icon11);
